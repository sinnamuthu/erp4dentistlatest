          ...
          <li class="nav-item navbar-dropdown dropdown-user dropdown">
            <a class="nav-link dropdown-toggle hide-arrow" href="javascript:void(0);" data-bs-toggle="dropdown">
              <div class="avatar avatar-online">
                ...
                <img src="/assets/img/favicon/erp4_logo.png" alt class="w-px-40 h-auto rounded-circle">
                @else
                @isset($profile[0]['image'])
                <img src="/hospital_logo/{{$profile[0]['image']}}" alt class="w-px-40 h-auto rounded-circle">
                @else
                <img src="/assets/img/favicon/erp4_logo.png" alt class="w-px-40 h-auto rounded-circle">
                @endisset
                @endif
            ...
            <ul class="dropdown-menu dropdown-menu-end">
              ...
              <li>
                <!-- final check-->
     <a class="dropdown-item" href="{{ route('profile.edit',base64_encode(auth()->user()->id)) }}">
